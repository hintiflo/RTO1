...
//	APOS_TASK_Create(&TASKA, "TaskA", 1, TaskA, stackTaskA, sizeof(stackTaskA), 10);
//	APOS_TASK_Create(&TASKB, "TaskB", 1, TaskB, stackTaskB, sizeof(stackTaskB), 10);
//	APOS_TASK_Create(&TASKC, "TaskC", 1, TaskC, stackTaskC, sizeof(stackTaskC), 10);
	
	
	
	APOS_TASK_Create(&TASKA, "TaskA", 100, TaskCounter, stackTaskA, sizeof(stackTaskA), 1);
	APOS_TASK_Create(&TASKB, "TaskB", 100, TaskKey, stackTaskB, sizeof(stackTaskB), 1);
	APOS_TASK_Create(&TASKC, "TaskC", 100, TaskLed, stackTaskC, sizeof(stackTaskC), 1);
	APOS_TASK_Create(&TASKD, "TaskD", 100, TaskWatch, stackTaskD, sizeof(stackTaskD), 1);
	APOS_TASK_Create(&TASKE, "TaskE", 100, TaskPoti, stackTaskE, sizeof(stackTaskE), 1);
	APOS_TASK_Create(&TASKF, "TaskF", 100, TaskMandelbrot, stackTaskF, sizeof(stackTaskF), 10);
//	
  Key_Init();
  Led_Init();
  Tft_Init();
